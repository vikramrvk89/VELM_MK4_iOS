...
public final class DropDown: UIView {
	...
	*/
	...
	//MARK: Appearance
    public var cellHeight = DPDConstant.UI.RowHeight {
		willSet { tableView.rowHeight = newValue }
		didSet { reloadAllComponents() }
	}

    fileprivate var tableViewBackgroundColor = DPDConstant.UI.BackgroundColor {
	...
	*/
	public var selectionBackgroundColor = DPDConstant.UI.SelectionBackgroundColor
	...
	*/
	public  var separatorColor = DPDConstant.UI.SeparatorColor {
	...
	*/
	public  var cornerRadius = DPDConstant.UI.CornerRadius {
		willSet {
	...
	*/
	public  var shadowColor = DPDConstant.UI.Shadow.Color {
	...
	Changing the shadow color automatically reloads the drop down.
	*/
	public  var shadowOffset = DPDConstant.UI.Shadow.Offset {
	...
	*/
	public  var shadowOpacity = DPDConstant.UI.Shadow.Opacity {
	...
	*/
	public  var shadowRadius = DPDConstant.UI.Shadow.Radius {
	...
	*/
	public  var animationduration = DPDConstant.Animation.Duration
	...
	*/
	public  var textColor = DPDConstant.UI.TextColor {
		didSet { reloadAllComponents() }
	}
	...
	*/
	public  var textFont = DPDConstant.UI.TextFont {
		didSet { reloadAllComponents() }
	}
